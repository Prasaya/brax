...
class Humanoid(env.Env):
    ...
    def __init__(
        ...
        **kwargs
        ...
        with open("/home/nevus/rl/brax/brax/envs/humanoid_cmu.proto") as f:
            config = f.read()
    ...
    def _get_obs(self, qp: brax.QP, info: brax.Info, action: jp.ndarray) -> jp.ndarray:
        ...
        cinert = [com_inr[:31].ravel()]
        cvel = [com_vel[:31].ravel(), com_ang[:31].ravel()]
    ...
    def _center_of_mass(self, qp):
        mass, pos = self.sys.body.mass[:31], qp.pos[:31]

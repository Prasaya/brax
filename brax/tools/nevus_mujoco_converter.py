...
flags.DEFINE_float("dt", 0.015, "Time to simulate each step, in seconds.")
flags.DEFINE_float("friction", 1, "How much surfaces in contact resist translation.")
flags.DEFINE_integer(
    "substeps", 8, "Substeps to perform to maintain numerical stability."
)
